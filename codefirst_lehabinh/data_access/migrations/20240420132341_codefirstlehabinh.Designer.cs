...
namespace codefirst_lehabinh.data_access.migrations
{
    ...
    [Migration("20240420132341_codefirstlehabinh")]
    partial class codefirstlehabinh
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("codefirst_lehabinh.Models.Khoa", b =>
                {
            ...
            modelBuilder.Entity("codefirst_lehabinh.Models.Lop", b =>
                {
            ...
            modelBuilder.Entity("codefirst_lehabinh.Models.SinhVien", b =>
                {
            ...
            modelBuilder.Entity("codefirst_lehabinh.Models.Lop", b =>
                {
                    b.HasOne("codefirst_lehabinh.Models.Khoa", "Khoa")
                        .WithMany("Lops")
            ...
            modelBuilder.Entity("codefirst_lehabinh.Models.SinhVien", b =>
                {
                    b.HasOne("codefirst_lehabinh.Models.Lop", "Lop")
                        .WithMany()
                        .HasForeignKey("LopId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
